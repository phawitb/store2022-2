...
def capture2(date,id,total):
    ...
    ret, frame = vid.read()
    cv2.imwrite(f'/home/phawit/Documents/store_tk/captures/products_{date}_{id}_{total}.png', frame)
    vid.release()
...
Label(f1, fg="white",bg="red",font= ('Helvetica 60 bold'),text="Deep Store by phawit.boo", width=25).pack(side=LEFT,padx=20, pady=20)
