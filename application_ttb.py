...
mbtn = Button(f6, width=11,height=2,fg='white',bg='red',text='Scan QR',font=bigFont,command=lambda m='QR': on_click2(m))
mbtn.grid(row=1, column=1, padx=5, pady=5)
